...
export async function deletePictureUsingPost(
  ...
  return request<API.ApiResponseBoolean_>('/api/picture/delete', {
    method: 'POST',
    headers: {
...
export async function editPictureUsingPost(
  ...
  return request<API.ApiResponseBoolean_>('/api/picture/edit', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function editPictureByBatchUsingPost(
  ...
  return request<API.ApiResponseBoolean_>('/api/picture/edit/batch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getPictureByIdUsingGet(
  ...
  return request<API.ApiResponsePicture_>('/api/picture/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getPictureVoByIdUsingGet(
  ...
  return request<API.ApiResponsePictureVo_>('/api/picture/get/vo', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listPictureByPageUsingPost(
  ...
  return request<API.ApiResponsePagePicture_>('/api/picture/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listPictureVoByPageUsingPost(
  ...
  return request<API.ApiResponsePagePictureVo_>('/api/picture/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listPictureVOCacheByPage POST /api/picture/list/page/vo/cache */
export async function listPictureVoCacheByPageUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.ApiResponsePagePictureVo_>('/api/picture/list/page/vo/cache', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function createPictureOutPaintingTaskUsingPost(
  ...
  return request<API.ApiResponseCreateOutPaintingTaskResponse_>(
...
export async function getPictureOutPaintingTaskUsingGet(
  ...
  return request<API.ApiResponseGetOutPaintingTaskResponse_>('/api/picture/out_painting/get_task', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function doPictureReviewUsingPost(
  ...
  return request<API.ApiResponseBoolean_>('/api/picture/review', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function searchPictureByPictureUsingPost(
  ...
  return request<API.ApiResponseListImageSearchResult_>('/api/picture/search/picture', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listPictureTagCategoryUsingGet(options?: { [key: string]: any }) {
  return request<API.ApiResponsePictureTagCategory_>('/api/picture/tag_category', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function updatePictureUsingPost(
  ...
  return request<API.ApiResponseBoolean_>('/api/picture/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function uploadPictureUsingPost(
  ...
  return request<API.ApiResponsePictureVo_>('/api/picture/upload', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function uploadPictureByBatchUsingPost(
  ...
  return request<API.ApiResponseInt_>('/api/picture/upload/batch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function uploadPictureByUrlUsingPost(
  ...
  return request<API.ApiResponsePictureVo_>('/api/picture/upload/url', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
