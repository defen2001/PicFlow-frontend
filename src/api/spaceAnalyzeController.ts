...
export async function getSpaceCategoryAnalyzeUsingPost(
  ...
  return request<API.ApiResponseListSpaceCategoryAnalyzeResponse_>('/api/space/analyze/category', {
    method: 'POST',
    headers: {
...
export async function getSpaceRankAnalyzeUsingPost(
  ...
  return request<API.ApiResponseListSpace_>('/api/space/analyze/rank', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getSpaceSizeAnalyzeUsingPost(
  ...
  return request<API.ApiResponseListSpaceSizeAnalyzeResponse_>('/api/space/analyze/size', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getSpaceTagAnalyzeUsingPost(
  ...
  return request<API.ApiResponseListSpaceTagAnalyzeResponse_>('/api/space/analyze/tag', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getSpaceUsageAnalyzeUsingPost(
  ...
  return request<API.ApiResponseSpaceUsageAnalyzeResponse_>('/api/space/analyze/usage', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getSpaceUserAnalyzeUsingPost(
  ...
  return request<API.ApiResponseListSpaceUserAnalyzeResponse_>('/api/space/analyze/user', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
