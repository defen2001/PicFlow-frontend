...
export async function addSpaceUserUsingPost(
  ...
  return request<API.ApiResponseLong_>('/api/spaceUser/add', {
    method: 'POST',
    headers: {
...
export async function deleteSpaceUserUsingPost(
  ...
  return request<API.ApiResponseBoolean_>('/api/spaceUser/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function editSpaceUserUsingPost(
  ...
  return request<API.ApiResponseBoolean_>('/api/spaceUser/edit', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getSpaceUserUsingPost(
  ...
  return request<API.ApiResponseSpaceUser_>('/api/spaceUser/get', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listSpaceUserUsingPost(
  ...
  return request<API.ApiResponseListSpaceUserVo_>('/api/spaceUser/list', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyTeamSpaceUsingPost(options?: { [key: string]: any }) {
  return request<API.ApiResponseListSpaceUserVo_>('/api/spaceUser/list/my', {
    method: 'POST',
    ...(options || {}),
  })
}
